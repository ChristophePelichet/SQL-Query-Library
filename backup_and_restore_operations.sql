-- A complete history of all SQL Server backup and restore operations on a server instance is stored in the msdb system database. 
-- To review the complete backup history of a database.
