-- The following set of T-SQL commands will help you identify if a database transaction log is not truncated and the reason for it. 
-- The following script will also recommend steps to resolve the issue:
-- Source : https://docs.microsoft.com/en-us/sql/relational-databases/logs/troubleshoot-a-full-transaction-log-sql-server-error-9002?view=sql-server-ver15
